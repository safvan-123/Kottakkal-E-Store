...
export default function Account() {
  ...
  if (!user) {
    return (
      <div className="text-center mt-10 text-base sm:text-lg font-medium">
        Loading user...
      </div>
    );
  }
  ...
  return (
    <div className="max-w-6xl mx-auto mt-16 sm:mt-20 px-4 sm:px-6 lg:px-8 pb-12">
      <div className="bg-white shadow-lg rounded-2xl overflow-hidden flex flex-col md:flex-row">
        {/* Sidebar/Profile Info */}
        <div className="bg-gray-50 p-6 sm:p-8 md:w-1/3 flex flex-col items-center text-center border-b md:border-b-0 md:border-r">
          <img
            src="https://static.vecteezy.com/system/resources/previews/036/280/650/non_2x/default-avatar-profile-icon-social-media-user-image-gray-avatar-icon-blank-profile-silhouette-illustration-vector.jpg"
            alt="Avatar"
            className="w-24 h-24 sm:w-28 sm:h-28 rounded-full border mb-3 sm:mb-4 object-cover"
          />
          ...
          <button
            ...
            className="mt-5 w-full sm:w-auto text-sm px-4 py-2 bg-red-600 text-white rounded-md hover:bg-red-700 transition"
          >
            Logout
          </button>
        </div>
        ...
        <div className="flex-1 p-6 sm:p-8">
          <div className="flex flex-col sm:flex-row sm:items-center sm:justify-between mb-6 gap-3">
            ...
            <button
              onClick={() => (editMode ? handleSave() : setEditMode(true))}
              className="text-sm px-4 py-2 w-full sm:w-auto bg-blue-600 text-white rounded-md hover:bg-blue-700 transition"
            >
              {editMode ? "Save" : "Edit"}
            </button>
          </div>
            ...
            <div>
              ...
              {editMode ? (
                <input
                  ...
                  value={formData.name}
                  onChange={handleChange}
                  className="w-full px-3 py-2 border rounded-md focus:outline-none focus:ring focus:ring-blue-300 text-sm sm:text-base"
                />
              ) : (
