...
//   // Get token from localStorage (adjust if you use Redux or cookies)
//   const { token } = useContext(AuthContext);
//   console.log(token);
...
//       );
//       alert("Address saved!");
//       navigate("/checkout"); // or back to checkout
//     } catch (err) {
//       console.error("Error saving address", err);
//       alert("Something went wrong");
//     }
...
//       <h2>{form._id ? "Edit" : "Add"} Delivery Address</h2>
...
//             required={field !== "altPhone" && field !== "landmark"}
//           />
//         ))}
